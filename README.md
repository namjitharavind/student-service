...
####   Since this service is idempotent, even though if the payment service or its downstream application failed, We can call the payment service gain manually or from another retry batch service which call exponentially
![img_9.png](img_9.png)
